export default function CertificateItem({ certificate }) {
  const { name, institution, skillsLearned, dateReceived, description, hyperlink } = certificate;
  ...
  return (
    <div className="border-2 border-gray-950 rounded-xl mx-4pl-2 p-2">
      ...
      <p className="break-all hyphens-auto mt-4 mb-4">{description}</p>
      ...
      {skillsLearned.map(skill => (
        ...
        <a href={hyperlink} className="block mt-2 hover:underline">
          View Certificate
        </a>
